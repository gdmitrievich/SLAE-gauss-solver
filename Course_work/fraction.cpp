...
Fraction::Fraction(int n1, int d1) : n(n1), d(d1) {
    ...
    // Если числитель равен нулю, то уже без разницы, что находится в
    // знаменателе, поэтому в качестве значения там будет 1.
    if (n == 0) {
        d = 1;
    }
    // Если дробь отрицательная, то знак отрицания должен быть в числителе, или
